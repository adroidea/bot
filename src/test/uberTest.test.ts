...
const { EventModel } = require('/usr/src/bot/src/models/eventModel.js');
const { GuildModel } = require('/usr/src/bot/src/models/guildModel.js');
...
describe('EventModel', function() {
  ...
  it('should update an existing event in the database', async function() {
    ...
    const updatedEvent = await EventModel.findByIdAndUpdate(eventId, { title: 'Updated Test Event' }, { new: true });

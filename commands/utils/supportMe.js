...
module.exports = {
    ...
    runInteraction(client, interaction) {
        const embed = new MessageEmbed()
            .setColor('#FFFF00')
            .setAuthor(
                { name: `${interaction.member.user.tag}`, iconURL: interaction.member.user.avatarURL() }
            )
            .setTitle('<:follow:816199077351784469> Si vous souhaitez me soutenir financièrement :')
            .setDescription('ㅤTu es déjà un turbo bg et tu suis déjà mes streams ? Merci beaucoup ! Tu veux aller plus loin dans le soutien que tu m\'apportes et tu souhaites contribuer à l\'amélioration de mes streams (ou m\'éviter de manger des pâtes tous les jours) ? C\'est ici !')
            ...
            .addFields(
                ...
                { name: '\u200B', value: '\u200B', inline: false },
                { name: '<a:catJAM:948587264554975272> Me soutenir ++', value: '\u200B', inline: false },
                { name: 'ㅤPaypal', value: 'ㅤㅤhttps://paypal.me/AdanneEA', inline: false },
                { name: 'ㅤDon en stream', value: 'ㅤㅤhttps://streamelements.com/adan_ea/tip', inline: false },
                { name: '\u200B', value: '\u200B', inline: false },
                {
                ...
                { name: 'ㅤInstant Gaming', value: 'ㅤㅤhttps://www.instant-gaming.com/?igr=adan-ea', inline: false },
                {
